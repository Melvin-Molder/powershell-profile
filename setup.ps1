...
Invoke-WebRequest -Uri https://github.com/Melvin-Molder/powershell-profile/raw/main/Microsoft.PowerShell_profile.ps1 -OutFile $Profile
Invoke-WebRequest -Uri https://github.com/JanDeDobbeleer/oh-my-posh/raw/main/themes/kali.omp.json -OutFile (Split-Path $Profile)
